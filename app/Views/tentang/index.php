        ...
        <div class="col-md-7 px-5 t">
            <div class="content-wrapper mx-auto" style="max-width: 600px;">
                ...
                <p class="text-start text-md-justify">
                    <?= ($lang == 'en') ? $tentang_kami['deskripsi_perusahaan_en'] : $tentang_kami['deskripsi_perusahaan']; ?>
                </p>
            </div>
        </div>
    </div>
            ...
            <?php foreach ($manfaatjoin as $item): ?>
                <div class="col">
                    <div class="card h-100 text-center shadow-sm">
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><?= ($lang == 'en') ? $item['judul_manfaat_en'] : $item['judul_manfaat']; ?></h5>
                            <p class="card-text"><?= ($lang == 'en') ? $item['deskripsi_manfaat_en'] : $item['deskripsi_manfaat']; ?></p>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
